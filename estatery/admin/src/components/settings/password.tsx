...
/**
 * Password settings – current password, new password, confirm.
 * Parent (Settings) handles save; we just manage the draft state.
 */
...
export function Password({ draft, onUpdateDraft }: PasswordProps) {
  // Eye icon toggles – show/hide each password field
