...
export function TopBar() {
  ...
  // When user picks a file, read it as base64 and update the profile avatar
  ...
  // First letter of username for avatar fallback when no image (e.g. "John" → "J")
  ...
  return (
    <>
      ...
      {/* Profile edit modal – shows when user clicks their avatar */}
      {profileOpen && (
